...
SAMPLE_BOOKS = [
    ...
    ("Charles Dickens",
     ...
     "Great Expectations",
     1861,
     "https://covers.openlibrary.org/b/isbn/9780141439563-M.jpg"),
    ("Mark Twain",
     "9780141439648",
     "Adventures of Huckleberry Finn",
     1884,
     "https://covers.openlibrary.org/b/isbn/9780141439648-M.jpg"),
    ("Virginia Woolf",
     "9780156907392",
     "Mrs Dalloway",
     1925,
     "https://covers.openlibrary.org/b/isbn/9780156907392-M.jpg"),
    ("George Orwell",
     "9780451524935",
     "1984",
     1949,
    ...
    ("J.K. Rowling",
     ...
     1997,
     "https://covers.openlibrary.org/b/isbn/9780747532743-M.jpg"),
    ("Toni Morrison",
     "9780307277671",
     "Beloved",
     1987,
     "https://covers.openlibrary.org/b/isbn/9780307277671-M.jpg"),
    ("Gabriel Garcia Marquez",
     "9780307389732",
     "One Hundred Years of Solitude",
     1967,
     "https://covers.openlibrary.org/b/isbn/9780307389732-M.jpg"),
    ("Fyodor Dostoevsky",
     "9780140449136",
...
def seed_books():
    with app.app_context():
        for item in SAMPLE_BOOKS:
            # support both 4-tuple and 5-tuple entries (with optional
            # cover_url)
            if len(item) == 5:
