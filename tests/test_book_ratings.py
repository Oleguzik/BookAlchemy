...
class TestAddBookWithRating:
    ...
    def test_add_book_with_rating_form_submission(
            self, app, client, auth_author):
...
class TestRatingDisplay:
    ...
    def test_edit_rating_button_on_rated_book_detail(
            self, client, app, auth_book):
